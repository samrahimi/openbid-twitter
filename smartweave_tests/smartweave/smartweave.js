module.exports = {
    ...
    interact: async function(arweave, wallet, contractID, input, dryRun, eventName=null, eventData=null) {
        ...
        if (eventName != null)
            interactionTX.addTag("Event-Name", eventName)
        if (eventData != null)
            interactionTX.addTag("Event-Data", eventData)
